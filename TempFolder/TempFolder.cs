...
public class TempFolder : IDisposable
{
    ...
    /// </summary>
    public TempFolder() : this(DefaultRoot, DefaultName)
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="TempFolder"/> class with a specified root path and name.
    /// </summary>
    ...
    private string DetermineRootPath(string root)
    {
